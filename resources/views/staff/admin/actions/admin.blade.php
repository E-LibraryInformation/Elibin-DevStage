...
@section('container')
    <div class="bg-slate-800 w-full h-max flex flex-col text-slate-300 rounded-lg">
        <div class="p-4">
            <h5 class="text-lg font-bold">List Table Admin</h5>
        </div>
        <div class="w-full p-4">
            <form action="" method="get" class="w-full">
                @csrf
                <div class="flex flex-row w-full">
                    <input type="text" name="searchUser" id="searchUser" class="w-full p-2 bg-slate-700 border rounded-l-lg focus:outline-sky-500" placeholder="Cari Admin...">
