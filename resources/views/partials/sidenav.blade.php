    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="/staff" class="flex ml-2 md:mr-24">
                    <span
                        class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">{{ $library->library }}</span>
                </a>
            </div>
                    ...
                    <div>
                        <button type="button"
                            ...
                            <img class="w-8 h-8 rounded-full"
                                src="{{ Auth::user()->gambar }}">
                        </button>
                    </div>
                    <div class="fixed top-14 right-8 z-50 hidden my-4 text-base list-none border bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                        id="dropdown-user">
