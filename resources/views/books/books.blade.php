...
@section('container')
    ...
    <div class="bg-slate-700 w-full h-max border rounded-md shadow-md text-slate-300">
        ...
        <div class="md:p-4 flex flex-wrap justify-center gap-6">
            ...
            <a href="/book/{{ $book->id }}" class="bg-slate-800 rounded-lg w-2/5 h-max overflow-hidden md:w-48 md:h-max hover:-translate-x-2 hover:-translate-y-2 hover:shadow-lg hover:shadow-purple-500 hover:duration-200 2xl:w-72">
                <div>
                    <img src="{{ $book->gambar }}" alt="{{ $book->judul }}" class="w-max">
                </div>
